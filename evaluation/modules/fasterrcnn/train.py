...
def train(num_epochs):
    ...
    dataset_train = CustomDataset('/data/data0/liuyiran/Zef3d/data/', data_type='train', transforms=get_transform(train=True))
    dataset_valid = CustomDataset('/data/data0/liuyiran/Zef3d/data/', data_type='valid', transforms=get_transform(train=False))
