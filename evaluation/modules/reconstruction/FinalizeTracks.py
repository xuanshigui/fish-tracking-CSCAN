...
class TrackFinalizer:
    ...
    def getDistances(self, galleryTrackID, mainTrackID):
        ...
        Output:
            ...
            validTrack: Whether the track is valid i.e. whether all values are within user defined thresholds
        '''
        ...
        # Check if any of the derived values are outside of the user defined thresholds
    ...
    def getCosts(self, metric_dict):
        ...
        Output:
            res: Dictionary containing the same keys as metric_dict, but now with probability values
        '''
    ...
    def costAssignment(self, tDistm, sDistm, iFramesm, iFramesRatiom, iTDistm, iSDistm, verbose=False):
        # If selected, perform initial Re-ID check. Else just get all metric probabilities
