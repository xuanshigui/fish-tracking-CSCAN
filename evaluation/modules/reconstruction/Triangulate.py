...
class Triangulate:
    ...
    def _triangulateRefracted(self, p1, p2, cam1, cam2, verbose=False):
        ...
        # 1) Back projects points into 3D ray
    ...
    def triangulatePoint(self, p1, p2, cam1, cam2, correctRefraction=True, verbose=False):    
        ...
        This is done projecting a ray from each of the camera through their respective 2D point,
        and finding the point closest to both rays
        ...
        Input:
            ...
            cam1: Camera object representing view 1
            cam2: Camera object representing view 2
            correctRefraction: Whether to correction for refraction when transitioning through air to water
