...
string.""", formatter_class=argparse.RawTextHelpFormatter)
    ...
    parser.add_argument('--groundtruths', type=str, help='Directory containing ground truth files.', default= '/data/data0/liuyiran/dataset/3dzef_sap/imgT/train')
    parser.add_argument('--tests', type=str, help='Directory containing tracker result files', default='/data/data0/liuyiran/trans3d/tracking/test_models/result_bak_important/fish3d_transcenter_top_default/txt')
