...
string.""", formatter_class=argparse.RawTextHelpFormatter)
    ...
    parser.add_argument('--groundtruths', type=str, help='Directory containing ground truth files.', default= '/data/data0/liuyiran/dataset/3dzef_rev/imgT/test')
    parser.add_argument('--tests', type=str, help='Directory containing tracker result files', default='/data/data0/liuyiran/trans3d/tracking/test_models/fish3d_top_joint_aifivb/txt')
