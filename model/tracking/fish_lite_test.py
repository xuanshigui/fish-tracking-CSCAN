...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='/data/data0/liuyiran/transcenter/tracking/test_models/fish_test_lite',
    ...
    parser.add_argument('--input_w', default=1056, type=int)
...
def main(tracktor):
    ...
    ds = FishDataset_val(root=main_args.data_dir, valset='test')
    ...
    for th in [0.4]:
        ...
        # tracker
        tracker = Tracker(model, None, None, tracktor['tracker'], postprocessor=postprocessors['bbox'],
                          main_args=main_args)
        tracker.public_detections = False
        tracker.mode = main_args.mode
        models = [
            "/data/data0/liuyiran/transcenter/output/fish_lite_default/checkpoint0049.pth",
        ]
        output_dirs = [
            curr_pth + '/test_models/fish_test_lite/',
        ]
...
with open(curr_pth + '/cfgs/transcenter_fish_cfg.yaml', 'r') as f:
