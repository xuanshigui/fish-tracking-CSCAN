...
from models.deformable_transformer_mod_enpntq import build_deforamble_transformer
import copy
...
class DeformableDETR(nn.Module):
    ...
    def forward(self, samples: NestedTensor, pre_samples: NestedTensor, pre_cts: Tensor, track_query):
        ...
        merged_hs, _, pre_gathered_features, _ = self.transformer(samples, pre_samples, pre_cts=pre_cts,
