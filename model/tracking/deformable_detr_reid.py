...
from models.deformable_transformer_reid import build_deforamble_transformer
import copy
from models.dla_cga import IDAUpV3_bis
...
def build(args):
    ...
    num_classes = 2 if args.dataset_file != 'coco' else 80
