...
class ShrimpsDataset_val(data.Dataset):
    # to test
    def __init__(self, root, valset="test", train_ratio=0.5):
        super(ShrimpsDataset_val, self).__init__()

        self.default_resolution = [960, 1280]
        self.dets_path = 'gt/gt.txt'
        self.root = root
