...
class Shrimp(GenericDataset):
  ...
  def __init__(self, opt, split):
    ...
    print('==> initializing Fish {} data.'.format(split))

    self.images = None
    # load image list and coco
    super(Shrimp, self).__init__(opt, split, ann_path, img_dir)
  ...
  def run_eval(self, results, save_dir):
    ...
    try:
      ...
      print('Fish evaluation not setup!')