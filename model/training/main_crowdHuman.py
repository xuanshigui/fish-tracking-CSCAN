...
from training.deformable_detr_mod import build as build_model
...
def get_args_parser():
    ...
    parser.add_argument('--pretrained', type=str, default="./model_zoo/pvtv2_backbone/pvt_v2_b2.pth",
                        help="pretrained")
    ...
    parser.add_argument('--data_dir', default='crowd_human', type=str)
...
def main(args):
    ...
    dataset_train = CrowdHuman(args, 'train')
    dataset_val = CrowdHuman(args, 'val')
